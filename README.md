...
- **Capability surfaces** (command / memory / policy / operator console / vessels / drones) at the **center**.
...
- When the router **serves a query**, the **surface → tier → model path lights up**; active models **glow**; **edge thickness = throughput**.
